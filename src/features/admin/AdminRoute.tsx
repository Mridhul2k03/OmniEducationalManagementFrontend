    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-xs text-slate-400 font-mono">Authenticating SuperAdmin session...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center bg-slate-900 text-white">
        ...
        <p className="mt-2 text-xs sm:text-sm text-slate-400 max-w-md leading-relaxed">
          The Platform Administration Console is reserved for global SaaS administrators. Your account (<span className="text-white font-mono">{user.email}</span>) is provisioned for tenant-scoped operations.
        </p>
